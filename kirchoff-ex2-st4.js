...
svg.appendChild(svgEl('circle', { cx:pos[n].x, cy:pos[n].y, r:3.5, 'class':'ct4node' }));
});
...
svg.appendChild(svgEl('line', {x1:270, y1:280, x2:270, y2:310, 'class':'ct4wire'}));
svg.appendChild(svgEl('line', {x1:270, y1:310, x2:60,  y2:310, 'class':'ct4wire'}));
svg.appendChild(svgEl('line', {x1:60,  y1:310, x2:60,  y2:30,  'class':'ct4wire'}));
svg.appendChild(svgEl('line', {x1:60,  y1:30,  x2:110, y2:30,  'class':'ct4wire'}));
var e1 = getById('E1');
if (e1) drawBatteryHorizontal(svg, e1, 140, 30);
svg.appendChild(svgEl('line', {x1:170, y1:30,  x2:270, y2:30,  'class':'ct4wire'}));
svg.appendChild(svgEl('line', {x1:270, y1:30,  x2:270, y2:60,  'class':'ct4wire'}));
}
...
+ '  <h3 class="ct4title' + '">Example 2 — Stage 4: Resistor Polarities (Bridge)</h3>'
...
+ '      <svg class="ct4svg' + '" id="ct4Svg' + thisq + '" viewBox="0 0 540 340" role="img" aria-label="Bridge circuit"></svg>'
